...
func access_go() (*asset, error) {
	...
	info := bindataFileInfo{name: "access_go", size: 273, mode: os.FileMode(420), modTime: time.Unix(1501055194, 0)}
...
func cmdNameMain_go() (*asset, error) {
	...
	info := bindataFileInfo{name: "cmd/{{.Name}}/main_go", size: 2969, mode: os.FileMode(420), modTime: time.Unix(1502360872, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func deploymentDeploymentYamlTemplate() (*asset, error) {
	...
	info := bindataFileInfo{name: "deployment/deployment.yaml.template", size: 1057, mode: os.FileMode(420), modTime: time.Unix(1502359784, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func protobufProtoProto() (*asset, error) {
	...
	info := bindataFileInfo{name: "protobuf/proto.proto", size: 310, mode: os.FileMode(420), modTime: time.Unix(1502360798, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func service_go() (*asset, error) {
	...
	info := bindataFileInfo{name: "service_go", size: 724, mode: os.FileMode(420), modTime: time.Unix(1501055194, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
