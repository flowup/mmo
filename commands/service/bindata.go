...
func templateMainGo() (*asset, error) {
	...
	info := bindataFileInfo{name: "template/main.go", size: 1266, mode: os.FileMode(436), modTime: time.Unix(1499787631, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
