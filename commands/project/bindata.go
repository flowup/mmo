...
// commands/project/template/CONTRIBUTING.md
// commands/project/template/ISSUE_TEMPLATE.md
// commands/project/template/LICENSE
// commands/project/template/PULL_REQUEST_TEMPLATE.md
...
func commandsProjectTemplateMmoYaml() (*asset, error) {
	...
	info := bindataFileInfo{name: "commands/project/template/mmo.yaml", size: 49, mode: os.FileMode(420), modTime: time.Unix(1499948200, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}

var _commandsProjectTemplateWerckerYml = []byte("\x1f\x8b\x08\x00\x00\x00\x00\x00\x00\xff\x4a\xca\xaf\xb0\x52\x48\xcf\xcf\x49\xcc\x4b\xb7\x32\xd4\xb3\xe4\xe2\x4a\x2a\xcd\xcc\x49\xb1\x02\x04\x00\x00\xff\xff\x15\x05\x18\x27\x17\x00\x00\x00")

func commandsProjectTemplateWerckerYmlBytes() ([]byte, error) {
	return bindataRead(
		_commandsProjectTemplateWerckerYml,
		"commands/project/template/wercker.yml",
	)
}

func commandsProjectTemplateWerckerYml() (*asset, error) {
	bytes, err := commandsProjectTemplateWerckerYmlBytes()
	if err != nil {
		return nil, err
	}

	info := bindataFileInfo{name: "commands/project/template/wercker.yml", size: 23, mode: os.FileMode(420), modTime: time.Unix(1499349093, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
