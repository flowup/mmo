...
func issue_templateMd() (*asset, error) {
	...
	info := bindataFileInfo{name: "ISSUE_TEMPLATE.md", size: 178, mode: os.FileMode(420), modTime: time.Unix(1500286209, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
var _pull_request_templateMd = []byte("\x1f\x8b\x08\x00\x00\x00\x00\x00\x00\xff\xd2\x55\x88\x56\x88\x55\xf0\x48\x2c\x4b\x55\xa8\xcc\x2f\x55\x48\xc9\xcf\x4b\x55\xb0\xe7\x22\x41\x14\x10\x00\x00\xff\xff\xf6\x91\xed\x6c\x41\x00\x00\x00")

func pull_request_templateMdBytes() ([]byte, error) {
	return bindataRead(
		_pull_request_templateMd,
		"PULL_REQUEST_TEMPLATE.md",
	)
}

func pull_request_templateMd() (*asset, error) {
	bytes, err := pull_request_templateMdBytes()
	if err != nil {
		return nil, err
	}

	info := bindataFileInfo{name: "PULL_REQUEST_TEMPLATE.md", size: 65, mode: os.FileMode(420), modTime: time.Unix(1500286209, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
var _werckerYml = []byte("\x1f\x8b\x08\x00\x00\x00\x00\x00\x00\xff\x4a\xca\xaf\xb0\x52\x48\xcf\xcf\x49\xcc\x4b\xb7\x32\xd4\xb3\xe4\xe2\x4a\x2a\xcd\xcc\x49\xb1\x02\x04\x00\x00\xff\xff\x15\x05\x18\x27\x17\x00\x00\x00")
...
func werckerYml() (*asset, error) {
	...
	info := bindataFileInfo{name: "wercker.yml", size: 23, mode: os.FileMode(420), modTime: time.Unix(1499349093, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
var _bintree = &bintree{nil, map[string]*bintree{
	...
	"CONTRIBUTING.md": &bintree{contributingMd, map[string]*bintree{}},
	"ISSUE_TEMPLATE.md": &bintree{issue_templateMd, map[string]*bintree{}},
	"LICENSE": &bintree{license, map[string]*bintree{}},
	"PULL_REQUEST_TEMPLATE.md": &bintree{pull_request_templateMd, map[string]*bintree{}},
