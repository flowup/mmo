...
func GithubContributingMd() (*asset, error) {
	...
	info := bindataFileInfo{name: ".github/CONTRIBUTING.md", size: 4216, mode: os.FileMode(420), modTime: time.Unix(1500385955, 0)}
...
func GithubIssue_templateMd() (*asset, error) {
	...
	info := bindataFileInfo{name: ".github/ISSUE_TEMPLATE.md", size: 178, mode: os.FileMode(420), modTime: time.Unix(1500385955, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func GithubPull_request_templateMd() (*asset, error) {
	...
	info := bindataFileInfo{name: ".github/PULL_REQUEST_TEMPLATE.md", size: 65, mode: os.FileMode(420), modTime: time.Unix(1500385955, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
